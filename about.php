...
<body>
 ...
 <  فئة  النموذج   = "بحث"
     ...
     <button>search</button>
       ...
       <img style="width: 100px;float: right;margin-right: 20px;" src="img/rg.png"  > 
    </nav>
    ...
    <div class="box">
        ...
        <form>
          <h5 style="color:white;">
              amazon is website store to buy clothes online at a good price. 
          </h5>  
          <h5 style="color:white;margin-left: 80px;">amazon shopping fun</h5>    
</form>
